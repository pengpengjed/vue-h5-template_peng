<template>
  <div class="cs-app-more">
    ...
    <van-popup
      ...
      round
      :position="isPadModule ? 'center' : 'bottom'"
      get-container="body"
      class="app-server-popup"
    >
...
export default {
  ...
  computed: {
    ...
    switchServerEnable() {
      ...
      if (!this.isInApp || (this.isInApp && this.isTestPlatform && this.isHomeModule)) {
        // 开发环境
